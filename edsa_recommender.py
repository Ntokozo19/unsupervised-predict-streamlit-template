...
def main():
    ...
    if page_selection == "About The App":
        ...
        <h3 style="color:black;text-align:right;">We are Team JS2 from Explore Data Science Academy. This is our  movie recommender project for 2021 July unsupervised sprint.</h3>
        """
        mission = """
	    <div style="background-color:#464e5f00;padding:10px;border-radius:10px;margin:10px;">
        ...
        <h3 style="color:black;text-align:center;">Ntokozo Thumre</h3>
        <h3 style="color:black;text-align:center;">Rachel Mogopa</h3>
        <h3 style="color:black;text-align:center;">Matsatsi Mankga</h3>
        <h3 style="color:black;text-align:center;">Noluthando Kuhlane</h3>
        <h3 style="color:black;text-align:center;">Thanyani Gumani</h3>
        <h3 style="color:black;text-align:center;">Jamie Snyders (Supervisor)</h3>
        """
